                                        ...
                                        <div class="pb-12 border-b border-gray-900/10">
                                            <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-5">
                                                <div class="sm:col-span-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <input type="text" name="name" id="name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:focus:ring-indigo-600 dark:text-gray-200">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sm:col-span-2">
                                                    ...
                                                    <div class="flex mt-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                                        ...
                                                        <input type="number" name="price" id="price" class="block w-full rounded-md border-0 shadow-sm ring-1 rounded-l-none ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 flex-1 bg-transparent py-1.5 text-gray-900 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:focus:ring-indigo-600 dark:text-gray-200">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sm:col-span-1">
                                                    ...
                                                    <div class="mt-2">
                                                        <input type="number" name="stock" id="stock" min="1" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:focus:ring-indigo-600 dark:text-gray-200" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
